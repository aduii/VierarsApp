...
public class CompraController {
	...
	//Registrar
	@RequestMapping(value = "/{recicladorID}/{usuarioID}/insertar", method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE)
	public Compra crearCompra(@PathVariable(value="recicladorID") int recicladorID, @PathVariable(value="usuarioID") int usuarioID,@RequestBody Compra t) {
	  return _compraService.insert(t,recicladorID ,usuarioID);
	}
